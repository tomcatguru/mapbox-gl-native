...
public class AttributionTest {
    ...
    public void beforeTest() {
        ...
        Intents.init();
        dialogTexts = rule.getActivity().getResources().getStringArray(R.array.attribution_names);
        dialogLinks = rule.getActivity().getResources().getStringArray(R.array.attribution_links);
    }
    ...
    public void testMapboxLink(){
        ...
        onView(withText(R.string.attributionsDialogTitle)).check(matches(isDisplayed()));
    ...
    public void testTelemetryDialog() {
        ...
        onView(withText(dialogTexts[3])).perform(click());
        onView(withText(R.string.attributionTelemetryTitle)).check(matches(isDisplayed()));
    }
